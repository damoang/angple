	...
	<div class="mb-8 flex items-center justify-between">
		<div class="flex items-center gap-4">
			...
			<div>
				...
				<p class="text-muted-foreground">테마의 모양과 동작을 사용자 정의하세요. 아래에서 실시간 미리보기를 확인하세요.</p>
			</div>
		</div>
									...
									<div class="space-y-2">
										...
										{#if field.type === 'boolean'}
											<div class="flex items-center justify-between">
												<Label for={`${category}-${key}`} class="flex flex-col gap-1">
		...
		<div class="space-y-4">
			<Card>
				<CardHeader>
					...
					<CardDescription>
						설정을 저장하면 즉시 반영됩니다. 디바이스 버튼으로 반응형 미리보기를 전환하세요.
					</CardDescription>
				</CardHeader>
				<CardContent>
					<div class="bg-muted flex min-h-[600px] items-center justify-center overflow-hidden rounded-lg p-4">
						<div
