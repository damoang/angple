...
import { getMemberById, findMemberByEmail, updateLoginTimestamp, isMemberActive } from '$lib/server/auth/oauth/member.js';
...
async function handleCallback(
	...
	try {
		...
		if (!mbId) {
			...
			cookies.set('pending_social_register', JSON.stringify({
