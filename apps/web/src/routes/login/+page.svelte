                ...
                {#each oauthProviders as provider}
                    ...
                    >
                        ...
                        {:else if provider.icon === 'kakao'}
                            <svg class="h-5 w-5" viewBox="0 0 24 24">
                                <path fill="#191919" d="M12 3c-5.065 0-9.167 3.355-9.167 7.5 0 2.625 1.757 4.937 4.403 6.278-.193.705-.7 2.555-.804 2.953-.127.497.182.49.385.357.159-.104 2.534-1.72 3.565-2.42.514.073 1.047.112 1.618.112 5.065 0 9.167-3.355 9.167-7.5S17.065 3 12 3" />
                            </svg>
                        {:else if provider.icon === 'naver'}
                            <svg class="h-5 w-5" viewBox="0 0 24 24">
                                <path fill="white" d="M16.273 12.845 7.376 0H0v24h7.727V11.155L16.624 24H24V0h-7.727z" />
                            </svg>
                        ...
                        {:else if provider.icon === 'payco'}
                            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="white">
                                <text x="2" y="18" font-size="14" font-weight="bold" font-family="Arial">P</text>
                            </svg>
                        {/if}
