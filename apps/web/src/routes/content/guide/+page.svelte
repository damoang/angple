<script lang="ts">
    ...
    const etiquette = [
        ...
        },
        {
            ...
            tone: 'mint',
            title: '이럴 땐 제한되지 않아요',
            desc: '의견이 다르다는 이유만으로는 제한되지 않습니다. 정치 사안 비판, 소수 의견, 운영에 대한 건의도 마찬가지예요. 보는 것은 「무엇을 말했나」가 아니라 「어떻게 말했나」입니다.'
        },
        {
            emoji: '⬜',
            tone: 'amber',
            title: '빈 댓글은 가끔이면 괜찮지만',
            desc: '빈 댓글 자체는 제한 대상이 아닙니다. 다만 같은 분에게 반복하거나 이유 없이 여러 번 남기면 이용방해로 볼 수 있어요.'
        },
        {
            emoji: '💢',
            tone: 'rose',
    ...
    const faqs = [
        ...
        {
            q: '정치 이야기를 하면 제한되나요?',
            a: '아니요. 의견이 다르다는 이유로 제한하지 않습니다. 소수 의견도 마찬가지예요. 보는 것은 표현하는 방식입니다.'
        },
        {
