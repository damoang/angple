    ...
    const etiquette = [
        {
            ...
            tone: 'mint',
            title: '경어체를 사용해 주세요',
            desc: '글도 댓글도 존댓말로. 여러 사람이 함께 보는 게시판에서는 혼잣말처럼 보이는 표현이라도 상대가 있는 자리에서는 반말로 받아들여집니다. 반말이 섞이면 안내를 드릴 수 있어요.'
        },
        {
            emoji: '🚫',
            tone: 'rose',
        ...
        },
        {
            ...
            desc: '운영정책은 「빈댓글을 작성하는 행위 역시 원론적으로 회원비하행위로 보지 않습니다」라고 정하고 있어요. 다만 같은 분에게 지나치게 반복하시면 회원비하·이용방해·예의없음에 해당할 수 있습니다.'
        },
        {
            emoji: '💢',
            tone: 'rose',
