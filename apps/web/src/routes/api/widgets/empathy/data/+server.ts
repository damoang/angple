/**
 * GET /api/widgets/empathy/data?period=6h
 *
...
import type { EmpathyPeriod } from '$lib/api/types';
import { loadEmpathyData } from '$lib/server/empathy-loader';
...
export const GET: RequestHandler = async ({ url }) => {
    ...
    const data = await loadEmpathyData(period as EmpathyPeriod);
