...
<DropdownMenu.Root onOpenChange={handleOpenChange}>
    ...
    >
        ...
        {#if unreadCount > 0}
            <span class="bg-primary noti-pulse absolute -right-0.5 -top-0.5 flex h-4 min-w-4 items-center justify-center rounded-full px-1 text-[10px] font-bold leading-none text-white"
