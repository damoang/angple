<script lang="ts">
    ...
    import {
        AVAILABLE_BOARDS,
        BOARD_FILTERABLE_WIDGET_TYPES
    } from '$lib/types/widget-settings';
    ...
    const isBoardFilterable = $derived(
        BOARD_FILTERABLE_WIDGET_TYPES.includes(widget.type as typeof BOARD_FILTERABLE_WIDGET_TYPES[number])
    );
