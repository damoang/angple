<script lang="ts">
    ...
    interface Props {
        date: string;
        dailyData: DailyEmpathyData | null;
    ...
    let pollData = $state<DailyEmpathyData | null>(null);
    ...
    let lazyComments = $state<DailyEmpathyData['comments'] | null>(null);
