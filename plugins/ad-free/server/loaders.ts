...
export async function loadLanding(_opts: LoadOptions = {}): Promise<LandingData> {
    return {
        ...
        faqs: [
            ...
            {
                q: '본문 하단·목록 사이 광고도 제거되나요?',
                a: '아니요. 본문 하단(글 댓글 영역 후) 과 게시판 목록 사이(in-feed) 광고는 운영 수익 보호 정책상 그대로 노출됩니다. 제거 대상은 PC 사이드바·윙·홈/탐색 하단 등 부수 슬롯입니다.'
            },
            {
                q: '다모앙 자체 광고도 제거되나요?',
                a: '아니요. 다모앙의 자체 광고앙 배너는 제거 대상이 아닙니다. 외부 광고 네트워크(Google AdSense) 의 PC 슬롯만 일부 제거됩니다.'
            },
            {
